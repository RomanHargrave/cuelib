...
public class GenreNormalizer {
     ...
     */
    private final static Logger logger = LoggerFactory.getLogger(GenreNormalizer.class);
    ...
    private GenreNormalizer() {
        GenreNormalizer.logger.warn("{} should not be instantiated.", GenreNormalizer.class.getCanonicalName());
    }
