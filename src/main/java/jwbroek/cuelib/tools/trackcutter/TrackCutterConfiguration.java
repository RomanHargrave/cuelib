...
public class TrackCutterConfiguration {
     ...
     */
    private final static Logger logger = LoggerFactory.getLogger(TrackCutterConfiguration.class);

    /**
     * Replacer for the template values.
     */
    private static final StringReplacer templateReplacer = new StringReplacer(getHumanReadableToFormatStringReplacements());
    ...
    private String getExpandedFileName(final TrackData trackData, final String fileNameTemplate) {
        ...
        final String result = String.format(this.getTemplateReplacer().replace(fileNameTemplate), normalizeFileName("" + trackData.getMetaData(CueSheet.MetaDataField.TITLE)), normalizeFileName("" + trackData.getMetaData(CueSheet.MetaDataField.PERFORMER)), normalizeFileName("" + trackData.getMetaData(CueSheet.MetaDataField.ALBUMTITLE)), normalizeFileName("" + trackData.getMetaData(CueSheet.MetaDataField.YEAR)), normalizeFileName("" + trackData.getMetaData(CueSheet.MetaDataField.COMMENT)), normalizeFileName("" + trackData.getMetaData(CueSheet.MetaDataField.TRACKNUMBER)), normalizeFileName("" + genre), normalizeFileName("" + GenreNormalizer.normalizeGenreDescription(genre, false, false)), normalizeFileName("" + GenreNormalizer.normalizeGenreDescription(genre, true, false)), normalizeFileName("" + GenreNormalizer.normalizeGenreDescription(genre, true, true)));
        return result;
    }
     ...
     */
    private String getExpandedProcessCommand(final TrackData trackData, final String processCommandTemplate, final String cutFileName, final String processFileName) {
        final String genre = trackData.getMetaData(CueSheet.MetaDataField.GENRE);
        final String result = String.format(this.getTemplateReplacer().replace(processCommandTemplate), trackData.getMetaData(CueSheet.MetaDataField.TITLE), trackData.getMetaData(CueSheet.MetaDataField.PERFORMER), trackData.getMetaData(CueSheet.MetaDataField.ALBUMTITLE), trackData.getMetaData(CueSheet.MetaDataField.YEAR), trackData.getMetaData(CueSheet.MetaDataField.COMMENT), trackData.getMetaData(CueSheet.MetaDataField.TRACKNUMBER), genre, GenreNormalizer.normalizeGenreDescription(genre, false, false), GenreNormalizer.normalizeGenreDescription(genre, true, false), GenreNormalizer.normalizeGenreDescription(genre, true, true), cutFileName, processFileName);
        return result;
    }
