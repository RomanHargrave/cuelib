...
public class TrackCutterCommand {
     ...
     */
    private final static Logger logger = LoggerFactory.getLogger(TrackCutterCommand.class);
        ...
        argumentsParser.registerOption(new SimpleOptionsParser.OptionHandler() {
                                           public int handleOption(String[] options, int offset) {
                                               ...
                                               try {
                                                   ...
                                                   TrackCutterCommand.logger.error("Error encountered when handling option 'rp'", e);
                                               } finally {
                                                   if (inputStream != null) {
                                                       try {
                                                           inputStream.close();
        ...
        argumentsParser.registerOption(new SimpleOptionsParser.OptionHandler() {
                                           public int handleOption(String[] options, int offset) {
                                               ...
                                               try {
                                                   ...
                                                   TrackCutterCommand.logger.error("Error encountered when handling option 'rx'", e);
                                               } finally {
                                                   if (inputStream != null) {
                                                       try {
                                                           inputStream.close();
    ...
    public void performProcessing(final String[] args) {
        ...
        if (this.getWritePropertiesConfigurationTo() != null) {
            try {
                ...
                TrackCutterCommand.logger.error("Error encountered when writing configuration", e);
            }
        }
        ...
        if (this.getWriteXmlConfigurationTo() != null) {
            try {
                ...
                TrackCutterCommand.logger.error("Error encountered when writing XML configuration", e);
            }
        }
        ...
        if (this.getDoProcessing()) {
            ...
            for (File cueFile : fileSet) {
                try {
                    ...
                    TrackCutterCommand.logger.error("Error encountered when processing CUE files", e);
                }
            }
            ...
            if (this.readCueSheetFromStdIn) {
                try {
                    ...
                    TrackCutterCommand.logger.error("Error encountered when processing CUE sheet from STDIN", e);
                }
            }
        }
     ...
     *
     * @param recursionDepth The recursion depth for file selection.
     *
