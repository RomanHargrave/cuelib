...
final public class TemporaryFileCreator {
    ...
    public static File createTemporaryDirectory() throws IOException, SecurityException {
        return TemporaryFileCreator.createTemporaryDirectory(null);
    }
    ...
    public static File createTemporaryDirectory(File baseDir) throws IOException, SecurityException {
        return TemporaryFileCreator.createTemporaryFileOrDirectory("TemporaryFileCreator", null, baseDir, true, false, 5);
    }
    ...
    public static File createTemporaryFile() throws IOException, SecurityException {
        return TemporaryFileCreator.createTemporaryFile(null);
    }
    ...
    public static File createTemporaryFile(File baseDir) throws IOException, SecurityException {
        return TemporaryFileCreator.createTemporaryFileOrDirectory("TemporaryFileCreator", null, baseDir, false, false, 5);
    }
     ...
     */
    public static File createTemporaryFileOrDirectory(final String prefix, final String suffix, final File directory, final boolean createDirectory, final boolean exactName, final int maxAttempts) throws IOException, IllegalArgumentException, SecurityException {
        ...
        StringBuilder nameBuilder = new StringBuilder(prefix).append(Double.toHexString(Math.random())).append(counterNumber);
        ...
        for (int attempt = 0; result == null && attempt < maxAttempts; attempt++) {
            try {
                ...
                ioException = e;
                TemporaryFileCreator.logger.error("Error encountered while creating temporary file", e);
            }
        }
     ...
     *                           the temporary file or directory to be created.
     */
    public static File createNamedTemporaryFileOrDirectory(final String name, final String suffix, final File directory, final boolean createDirectory, final boolean exactName) throws IOException, IllegalArgumentException, SecurityException {
